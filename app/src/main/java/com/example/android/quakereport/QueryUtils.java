...
public final class QueryUtils {
    ...
    static ArrayList<Earthquake> fetchEarthquakeList(String requestUrl) {
        ...
        return getEarthquakesDetails(jsonResponse);
    ...
    private static ArrayList<Earthquake> getEarthquakesDetails(String jsonResponse) {
        ...
        try{
            ...
            for (int i = 0; i < earthquakesArray.length(); i++) {
                ...
                Date time = new java.util.Date(properties.getLong("time"));
